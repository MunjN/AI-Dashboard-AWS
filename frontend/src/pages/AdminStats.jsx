...
export default function AdminStats() {
  ...
  if (err) {
    return <div className="p-6 text-red-700">{err}</div>;
  }
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between gap-3">
        <h1 className="text-2xl font-semibold text-blue-950">Admin Stats</h1>

        <div className="flex items-center gap-3">
          {/* ✅ NEW: Manage Tools button */}
          <a
            href="/admin/tools"
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <StatsCard label="Unique Users" value={uniqueUsers} />
        <StatsCard label="Top User" value={topUsers?.[0]?.email || "—"} />
        <StatsCard label="Top Deployment" value={topOrigin} />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Top Users */}
        <div className="bg-white border border-blue-100 rounded-xl p-4 shadow-sm">
          <h2 className="text-lg font-semibold text-blue-950">Top Users</h2>
          <div className="mt-3 overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="text-left text-blue-900/80">
                  ...
                  <th className="p-2">Logins</th>
                  <th className="p-2">Last Login</th>
                  <th className="p-2">Last Deployment</th>
                </tr>
              </thead>
              <tbody>
                {topUsers?.map((u) => (
                  <tr key={u.email} className="border-t">
                    ...
                    <td className="p-2">{u.lastOrigin || "unknown"}</td>
                  </tr>
                ))}
        ...
        {/* Logins last 30 days */}
        <div className="bg-white border border-blue-100 rounded-xl p-4 shadow-sm">
          <h2 className="text-lg font-semibold text-blue-950">Logins (Last 30 Days)</h2>
          <div className="mt-3 overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="text-left text-blue-900/80">
...
function StatsCard({ label, value }) {
  return (
    <div className="bg-white border border-blue-100 rounded-xl p-4 shadow-sm">
      ...
      <div className="text-2xl font-semibold text-blue-950 mt-1">{value}</div>
    </div>
  );
}
